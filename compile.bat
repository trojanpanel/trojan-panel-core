...
SET GOOS=linux
SET GOARCH=arm
garble -literals -tiny build -o build/trojan-panel-core-linux/arm/v6 -trimpath -ldflags "-s -w -buildid="
garble -literals -tiny build -o build/trojan-panel-core-linux/arm/v7 -trimpath -ldflags "-s -w -buildid="
::Linux arm64
SET CGO_ENABLED=0
SET GOOS=linux
SET GOARCH=arm64
